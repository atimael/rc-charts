...
const nodeWidth = 100;
const nodeHeight = 60;
const nodeMargin = 100; // Margin between nodes
...
export const CallJourney: React.FC = () => {
  ...
  const { nodes, edges } = useMemo(() => {
    const rowLimit = Math.max(1, Math.floor(containerWidth / (nodeWidth + nodeMargin))); // Calculate how many nodes can fit into one row
